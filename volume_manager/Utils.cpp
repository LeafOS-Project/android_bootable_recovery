...
const char* sBlkidContext = nullptr;
const char* sBlkidUntrustedContext = nullptr;
const char* sFsckContext = nullptr;
const char* sFsckUntrustedContext = nullptr;
...
status_t ForkExecvp(const std::vector<std::string>& args, const char* context) {
